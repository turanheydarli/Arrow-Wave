...
{
    [SerializeField] private TMP_Text maxArrowText;
    ...
    public void Show_Rotate_Button(Action rotate_clicked)
    {
        // Called by Paint_Effect
    ...
    public void Rotate_Button_Clicked()
    {
        // Called by button
    ...
    public void Show_Next_Button(Action next_clicked)
    {
        // Called by Paint_Effect
    ...
    {
        if (GDG.Player_Control != null)
            maxArrowText.text =
                $"{GDG.Player_Control.Bow_Control.Active_Arrows.Count}/{GDG.Player_Control.Bow_Control.MaxActiveArrows}";
