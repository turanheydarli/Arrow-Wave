...
public class Game_Control : MonoBehaviour, Pointer_Down_Listener, Pointer_Up_Listener, Drag_Listener
{
    ...
    private void Load_Game_Data()
    {
        ...
        Coins = (int)CurrencyManager.GetCurrency(CurrencyType.Coin).Amount;
    ...
    {
        CurrencyManager.SaveAllCurrencies();
    ...
    private void Load_Level()
    {
        ...
        SceneManager.LoadScene(Current_Scene_Name,
            LoadSceneMode.Additive); // Load level scene and start on scene loaded
    }
    ...
    public void Start_Level(Action level_ready_callback, Action level_completed_callback, Action level_failed_callback)
    {
        // Called by Game_Section
    ...
    public void Level_Completed()
    {
        ...
        CurrencyManager.AddToCurrency(CurrencyType.Coin, Current_Level_Coins);
